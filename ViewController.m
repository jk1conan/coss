...
//        NSLog(@"http://%@:%@/openrdp/get_vm_info.php",IP,port);
    self.urlstr = [NSString stringWithFormat:@"http://%@:%@/openrdp/get_vm_info.php",IP,port];
 //       NSLog(@"%@",_urlstr);
    }
...
//    // Do any additional setup after loading the view from its nib.
    ...
    webView = [[UIWebView alloc] initWithFrame:CGRectMake(10, 10, 320, 480)];
...
//            
        ...
        //    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle].resourcePath stringByAppendingPathComponent:@"index.html"]];
...
- (void)readManualBookmarksFromDataStore {
    ...
    // [[bm params] setValue:@"C:\\Program Files (x86)\\CloudTerm\\ct\\ctlogin.exe user010 111111" forKey:@"remote_program"];
    [[bookmark params] setValue:@"C:\\Program Files (x86)\\CloudTerm\\ct\\ctlogin.exe testzs 111111" forKey:@"remote_program"];
    
    [[bookmark params] setValue:@"1" forKey:@"username"];
    [[bookmark params] setValue:@"111111" forKey:@"password"];
